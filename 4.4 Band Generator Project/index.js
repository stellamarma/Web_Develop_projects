...
app.post("/submit", (req, res) => {
  ...
  //3. Test to make sure that the random words display in the h1 element in index.ejs
   ...
   // Δημιουργία τυχαίων αριθμών για επιλογή επίθετου και ουσιαστικού
   const rng1 = Math.floor(Math.random() * i);
   const rng2 = Math.floor(Math.random() * j);
 
   // Συνδυασμός επίθετου και ουσιαστικού για το όνομα της μπάντας
   let bandname = adj[rng1] + " " + noun[rng2];
 
   // Αποστολή του bandname πίσω στο template
